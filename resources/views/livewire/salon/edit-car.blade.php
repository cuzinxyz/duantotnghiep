<div class="mb-50 wow fadeInUp contact-page container" data-wow-delay="200ms"
            ...
            <div class="col-lg-12">
                <div class="">
                    <div class="alert alert-info" role="alert">
                        <span class="fs-5"><i class="text-warning bi bi-megaphone-fill"></i></span> Vì quy định kiểm
                        duyệt, khi bạn cập nhật lại thông tin bài đăng cần phải được quản trị viên <strong>phê duyệt
                            lại</strong>, vui lòng cân nhắc trước khi sửa!
                    </div>
                            ...
                            <div class="col-6 p-2">
                                ...
                                <div class="custom-file-container" data-upload-id="mySecondImage">
                                    <div class="label-container">
                                        <label class="fw-bold" style="font-size: 13px">Upload hình mới</label>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-20">
                                        <div class="form-inner">
                                            <label class="">Hãng chế tạo <span class="text-danger fw-bold">(*)</span><span class="text-danger fw-bold">(*)</span></label>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        <div class="form-inner">
                                            <label class="">Phiên bản <span class="text-danger fw-bold">(*)</span></label>
                    ...
                    <div class="inquiry-form" id="form-sell-2">
                        <div class="mb-15">
                            <h5 class="">Xác nhận lại thông tin của bạn <span class="text-danger fw-bold">(*)</span></h5>
                        </div>
