                        ...
                        <div class="inquiry-form" id="form-sell-2">
                            ...
                            <div class="alert alert-info">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item storeEmail">Email:
                                        <strong>{{ $salonInfo->email }}</strong>
                                    </li>
                                </ul>
                            </div>
                        </div>

                        <div class="row inquiry-form justify-content-evenly" id="form-sell-3">
                            ...
                            <div class="col-lg-12" style="margin-top: 24px" wire:loading.remove>
                                <div class="form-inner" style="text-align: center">
                                    <button wire:loading.attr="disabled"
                                        class="fs-6 w-50 btn btn-lg justify-content-center align-items-center primary-btn2 shadow-md"
                                        style="height: 50px" wire:click.prevent="saveCar">Sửa tin</button>
                                </div>
                            </div>
