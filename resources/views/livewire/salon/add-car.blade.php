<div>
    <div class="mb-50 wow fadeInUp container contact-page" data-wow-delay="200ms"
                            ...
                            <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-20">
                                            <div class="form-inner">
                                                ...
                                                <select class="nice-select beauty-shadow"
                                                    wire:model.live="brand_select">
                                ...
                                <div class="col-md-4 col-sm-12 mb-20">
                                    <div class="form-inner form-inner-padding mb-20 blurBG bg-shape" style=""
                                        id="changeColor">
                                        <label style="background: #fff;display:inline" class="rounded p-1">Màu
                                            sắc</label>
                                        <div class="color-select row gy-2">
                                            @foreach ($colors as $key => $color)
                                                <div class="col-6">
                                                    <input {{ $key == 'black' ? 'checked' : '' }} hidden
                                                        type="radio" wire:model="color"
                                                        data-color="{{ $key }}" value="{{ $color }}"
                                                        id="{{ $key }}" name="colorpicker">
                                                    <label for="{{ $key }}"
                                            ...
                                            <div class="radio-tile-group">
                                                ...
                                                <div class="input-container">
                                                    ...
                                                    <div class="radio-tile">
                                                        ...
                                                        <label for="bike" class="radio-tile-label">Số tự
                                                            động</label>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="inquiry-form" id="form-sell-2">
                            ...
                            <div class="alert alert-info">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item storeName">Tên cửa hàng: <strong>{{ $salonInfo->salon_name }}</strong></li>
                                    <li class="list-group-item storeAddress">Địa chỉ cửa hàng: <strong>{{ $salonInfo->address }}</strong></li>
                                    <li class="list-group-item storePhoneNumber">Số điện thoại: <strong>{{ $salonInfo->phone_number }}</strong></li>
                                    <li class="list-group-item storeEmail">Email: <strong>{{ $salonInfo->email }}</strong></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row inquiry-form justify-content-evenly"
                            ...
                            <div class="col-lg-12" style="margin-top: 24px" wire:loading.remove>
                                <div class="form-inner" style="text-align: center">
                                    <button wire:loading.attr="disabled" class="fs-6 w-50 btn btn-lg justify-content-center align-items-center primary-btn2 shadow-md" style="height: 50px"
