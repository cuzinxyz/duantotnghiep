<div>
    ...
    <div class="text-input-area mb-40">
        <form>
            ...
            <input class="phone" type="text" placeholder="Số điện thoại..." wire:model="phoneNumber"
                name="phone_number">
            <div class="form-inner form-content">
                <textarea class="content" wire:model="content" placeholder="Nội dung muốn đăng..."></textarea>
                <button type="submit" wire:click.prevent="save">
                    <div wire:loading>Add post</div>
            ...
            <div class="comments">
                <div class="comment-react">
                    <button data-bs-toggle="tooltip" data-bs-placement="top"
                        title="Liên hệ: {{ auth()->user()->phone_number }}">
