                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-inner mb-30">
                                                ...
                                                <div style="padding-top:10px">@error('title') {{ $message }} @enderror</div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-inner mb-30">
                                                ...
                                                <div style="padding-top:10px">@error('content') {{ $message }} @enderror</div>
                                            </div>
                                        </div>
                                    </div>
