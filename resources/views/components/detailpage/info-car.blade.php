                        ...
                        <div class="dialog__content">
                            <div class="list-group mt-3 list-group-light">
                                <div class="item_report mb-2">
                                    <input class="form-check-input" type="checkbox" value="Lừa đảo"
                                        id="luadao" />
                                ...
                                <div class="item_report mb-2">
                                    <input class="form-check-input" type="checkbox" value="Thông tin sai sự thật"
                                        id="saithongtin" />
                                    <label for="saithongtin">Thông tin sai sự thật</label>
                                </div>
                                <div class="item_report mb-2">
                                    <input class="form-check-input" type="checkbox" value="Ngôn ngữ gây thù ghét"
                                        id="ngonngu" />
