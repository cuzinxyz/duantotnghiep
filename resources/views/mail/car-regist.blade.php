            ...
            <table class="pc-project-container" style="width: 600px; max-width: 600px;" width="600" align="center"
                                                                    ...
                                                                    <td style="padding: 0px 0px 40px 0px;">
                                                                        <table
                                                                            ...
                                                                            <tr class="pc-grid-tr-first">
                                                                                <td class="pc-grid-td-first pc-w620-padding-30-0"
                                                                                    align="left" valign="top"
                                                                                    style="width: 50%; padding-top: 0px; padding-right: 20px; padding-bottom: 20px; padding-left: 0px;">
             ...
             Tiêu đề tin                                                                                                                      </td>
                                                                                                        ...
                                                                                                        <td align="left"
                                                                                                            ...
                                                                                                            <table
                                                                                                               ...
                                                                                                               <![endif]-->
                                                                                                                                ...
                                                                                                                                <td height="1"
                                                                                                                                    valign="top"
                                                                                                                                    style="line-height: 1px; font-size: 1px; border-bottom: 1px solid #e5e5e5;">
                                                                                                                                    &nbsp;
                                                                                                                                </td>
                                                                                                                                <!--<![endif]-->
                                                                                                                            </tr>
                                                                            ...
                                                                            <tr class="pc-grid-tr-last">
                                                                                <td class="pc-grid-td-first pc-w620-padding-30-0"
                                                                                    align="left" valign="top"
                                                                                    style="width: 50%; padding-top: 20px; padding-right: 20px; padding-bottom: 0px; padding-left: 0px;">
                                                                                    <table width="100%" border="0"
                                                                                           cellpadding="0"
                                                                                           cellspacing="0"
                                                                                           role="presentation"
                                                                                ...
                                                                                <td align="left" valign="top"
                                                                                    ...
                                                                                    <table border="0" cellpadding="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td valign="top"
                                                                                                class="pc-font-alt"
                                                                                                style="mso-line-height: exactly;line-height: 26px;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 22px;font-weight: bold;color: #151515;">
                                                                                                Thông số kỹ thuật
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                                                    ...
                                                                                                                    <th valign="top"
                                                                                                                        ...
                                                                                                                        <table
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td valign="top"
                                                                                                                                    class="pc-font-alt"
                                                                                                                                    style="mso-line-height: exactly;line-height: 26px;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 16px;font-weight: 300;color: #151515;">
                                                                                                                                    Hãng
                                                                                                                                    xe:
                                                                                                                                </td>
                                                                                                                            </tr>
