    ...
    <table bgcolor="#f4f4f4" border="0" cellpadding="0" cellspacing="0" class="pc-project-body" role="presentation"
        ...
        <tr>
            <td align="center" valign="top">
                <table align="center" border="0" cellpadding="0" cellspacing="0" class="pc-project-container"
                    role="presentation" style="width: 600px; max-width: 600px;" width="600">
                    <tr>
                                                                            ...
                                                                            <table border="0" cellpadding="0"
                                                                                ...
                                                                                <tr>
                                                                                    <td class="pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-40"
                                                                                        ...
                                                                                        valign="top">
                                                                                        <div><span>Xin chào {{$user->name}},</span>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0px 0px 20px 0px;"
                                                                            ...
                                                                            <table border="0" cellpadding="0"
                                                                                cellspacing="0" role="presentation">
                                                                                <tr>
                                                                                    <td class="pc-font-alt pc-w620-fontSize-18 pc-w620-lineHeight-28"
                                                                                        style="mso-line-height: exactly;line-height: 150%;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 20px;font-weight: normal;color: #0f0d0d;"
                                                                                        valign="top">
                                                                                        <div><span>Cửa hàng của bạn sẽ hết bạn vào ngày
                                                                                            Vui lòng gia hạn cửa hàng để tiếp tục sử dụng dịch vụ,
                                                                                            nếu bạn không gia hạn chúng tôi sẽ buộc lòng đóng cửa hàng của bạn.
                                                                                            Trân trọng cảm ơn.
                                                                                        </span> </div>
                                                                                    </td>
                                                                                </tr>
