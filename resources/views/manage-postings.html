...
<body class="tt-magic-cursor">
    ...
    <header class="header-area style-1">
        <div class="header-logo d-lg-none d-flex">
            <a href="index.html"><img alt="image" class="img-fluid" src="images/logo.svg"></a>
        </div>
        <div class="main-menu">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 d-flex align-items-end justify-content-between flex-wrap gap-4 mb-4">
                                    ...
                                    <div class="d-flex align-items-center p-1 rounded"
                                        style="background-color: #f4f4f4;">
                                        <img src="/images/dongTot.svg" alt="Đồng Tốt"
                                            style="width: 1rem; height: 1rem;">
                ...
                <div class="col-lg-12">
                    <div class="nav nav2 nav  nav-pills" id="v-pills-tab2" role="tablist" aria-orientation="vertical">
                        ...
                        <button class="nav-link" id="v-pills-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-2"
                            type="button" role="tab" aria-controls="v-pills-2" aria-selected="true">Hết hạn (0)</button>
                        ...
                        <button class="nav-link" id="v-pills-7-tab" data-bs-toggle="pill" data-bs-target="#v-pills-7"
                            type="button" role="tab" aria-controls="v-pills-7" aria-selected="true">Đã ẩn (0)</button>
                    </div>
                                ...
                                <div class="row g-lg-4 gy-5">
                                    <div class="col-lg-7">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <img src="images/product-img-02.png" alt="" width="260px"; height="260px">
                                            </div>
                                            <div class="">
                                        ...
                                        <div class="d-flex justify-content-between my-3">
                                            ...
                                            <div>
                                                <a href="" class="btn border"><i class="bi bi-arrow-counterclockwise"></i> Gia hạn tin</a>
                                                <a href="" class="btn border"><i class="bi bi-pencil"></i> Sửa tin</a>
                                                <a href="" class="btn border"><i class="bi bi-eye-slash"></i> Ẩn tin</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                ...
                <div class="contact-area">
                    ...
                    <div class="hotline-area">
                        ...
                        <div class="content">
                            ...
                            <h6><a href="/cdn-cgi/l/email-protection#a1c8cfc7cee1c6ccc0c8cd8fc2cecc"><span
                                        class="__cf_email__"
                                        data-cfemail="6f060109002f08020e0603410c0002">[email�&nbsp;protected]</span></a>
                            </h6>
                        </div>
                    </div>
                </div>
