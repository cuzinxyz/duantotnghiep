        ...
        <div class="container py-4" style="max-width:1200px">
            <div class="row ">
                <div class="col-lg-6  mb-lg-0">
                    <div class="card cascading-right"
                        ...
                        <div class="card-body shadow-5 ">
                            <h2 class="fw-bold text-center">Đăng nhập</h2>
                            <form class="form" action="{{ route('login') }}" method="POST">
                                ...
                                <p class="p">Chưa có tài khoản? <a href="{{route('register')}}" class="span">Đăng kí</a>
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <img src="{{ asset('images/image_login.jpg') }}" class="w-100 w-75 rounded-4 shadow-4 h-75" alt="" />
                </div>
            </div>
        </div>
        <!-- Jumbotron -->
