...
use App\Listeners\ByCarCollaboratorListener;
use App\Models\User;
...
use App\Listeners\SalonCollaboratorListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        SalonCollaboratorEvent::class => [
            SalonCollaboratorListener::class,
        ],

        ByCarCollaboratorEvent::class => [
            ByCarCollaboratorListener::class
        ]
